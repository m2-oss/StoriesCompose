...
``` kotlin
dependencies {
   implementation("com.github.m2-oss.StoriesCompose:stories:1.3.12") // base functionality (mandatory)
   implementation("com.github.m2-oss.StoriesCompose:stories-video:1.3.12") // video stories (optional)
}
